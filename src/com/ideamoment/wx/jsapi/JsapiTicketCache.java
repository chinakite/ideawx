...
public class JsapiTicketCache {
    ...
    //使用默认容量创建一个Map  
    private static ConcurrentHashMap<String, JsapiTicketCacheEntity> cache = new ConcurrentHashMap<String, JsapiTicketCacheEntity>(DEFAULT_CAPACITY);
    ...
    */  
    public static boolean putValue(String key, String value, int expireTime) {  
        ...
        JsapiTicketCacheEntity atce = new JsapiTicketCacheEntity(value, System.nanoTime(), expireTime);
        cache.put(key, atce);
        return true; 
    }  
    ...
    static class TimeoutTimerThread implements Runnable {
        ...
        private void checkTimeout() throws Exception {
            ...
            for (String key : cache.keySet()) {
                JsapiTicketCacheEntity tce = cache.get(key);
